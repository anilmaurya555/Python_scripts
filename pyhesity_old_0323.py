...
APIROOTMCM = 'https://urldefense.com/v3/__https://helios.cohesity.com/mcm/__;!!OUZQVuLPJGsF!h17r1XcdBrV8fzFSGTclPN-WRZv7n3rCtox_zuaeJ4jookxN7wtyN19_jKUYlNTa2tbH-Q$ '
...
def apiauth(vip='helios.cohesity.com', username='helios', domain='local', password=None, updatepw=None, prompt=None, quiet=None, helios=False, useApiKey=False, tenantId=None, noretry=False):
    ...
    if vip == 'helios.cohesity.com':
        ...
        URL = 'https://urldefense.com/v3/__https://helios.cohesity.com/mcm/clusters/connectionStatus__;!!OUZQVuLPJGsF!h17r1XcdBrV8fzFSGTclPN-WRZv7n3rCtox_zuaeJ4jookxN7wtyN19_jKUYlNSSJ29UPA$ '
        try:
